...
public class RocksDBClient extends DB {
  ...
  public Status read(final String table, final String key, final Set<String> fields,
    ...
    try {
      ...
      //}
      ////////////////////////////////////////////////////////////////
      String content = "Query " + Integer.parseInt(key) + " -> " + Integer.parseInt(key) + ":" +  "\n";
  ...
  public Status update(final String table, final String key, final Map<String, ByteIterator> values) {
    ...
    try {
      ...
      ////////////////////////////////////////////////////////////////
      String content = "U " + Integer.parseInt(key) + " " + Integer.parseInt(key) + "\n";
      //System.out.print(content);
      File file = new File("test.txt");
      if(!file.exists()){
        file.createNewFile();
  ...
  public Status insert(final String table, final String key, final Map<String, ByteIterator> values) {
    try {
      ...
      ////////////////////////////////////////////////////////////////
      String content = "Inserting " + Integer.parseInt(key) + "\n";
      //System.out.print(content);
      File file = new File("test.txt");
      if(!file.exists()){
        file.createNewFile();
